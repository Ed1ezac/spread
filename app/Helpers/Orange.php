...
class Orange{
    ...
    /**
     * Creates a new Orange instance. If the user doesn't know his token or doesn't have a
    ...
    /**
     * Retrieves a token from Orange server, 
     * that will be used for all further API calls.
     * @return array
     */
