<template>
    <div class="shadow-md ml-4 mt-4 p-2 w-36 hover:shadow-lg border border-gray-300 bg-white overflow-hidden rounded-md">
        ...
        <div class="flex justify-center flex-col">
            ...
            <h3 class="mt-2 flex-sm-wrap">{{ list.name }}</h3>
            <p class="mt-2 text-xs text-gray-400">6034585 entries</p>
            </div>
        </div>
    </div> 
</template>
