    ...
    <div v-show="true" class="shadow-sm overflow-hidden divide-y divide-dashed divide-gray-300 rounded mb-10 mr-4 xl:mr-6 max-w-7xl border-t-4 border-gray-500">
        <div class="mb-2 px-4">
            <div class="flex justify-between my-2">
                ...
                <div class="flex mr-1">
                    ...
                    <div v-if="!isDiscovered" class="animate-pulse bg-gray-300 ml-2 rounded h-4 w-16"></div>
                    <h3 v-else class="text-gray-500 ml-2 text-sm font-bold">{{recipientsName}}</h3>
                </div>
            </div>
        ...
        <div class="bg-gray-100 mt-2 px-4 pt-2 pb-3 space-y-2">
            <div class="flex items-center">
                ...
                <div v-if="!isDiscovered" class="animate-pulse bg-gray-300 ml-4 rounded h-4 w-16"></div>
                <h3 v-else class="text-sm font-bold ml-4 pt-1 text-gray-600">{{smsSender}}</h3>
            </div>
            <div class="flex h-20 md:h-14">                
                ...
                <div class="bg-gray-200 ml-4 px-2 p-1 w-full border-gray-400 border-2">
                    <div v-if="!isDiscovered" class="animate-pulse">
    ...
    computed: {
        ...
        canAbort(){
            return !this.aborted && this.isDiscovered && 
                (this.total >= 10000 ? this.current < 1500 : this.percentage < 15);
        },
        isCompleted(){
