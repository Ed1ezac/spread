<template>
    <div>
        <div class="shadow overflow-visible rounded-sm bg-white w-112 border-t-4 mb-2 mr-4 sm:mr-0 border-accent-600">
            <form :action="formAction" method="POST">
                <input type="hidden" name="_token" :value="csrf">
                <input v-if="sms.id" type="hidden" :value="sms.id" name="id">
                <div class="relative px-4 pb-3 space-y-5 sm:p-6 sm:pt-0">
                    ...
                    <div class="flex items-center mt-1"> 
                        ...
                        <div class="leading-5 text-sm text-gray-600 self-center ml-3 ">
                            <span class="text-base font-semibold">"{{ messagingList.name + '" '}}</span> -
                            <span class="text-lg font-light">{{ messagingList.entries }}</span> recipients
                        </div>
