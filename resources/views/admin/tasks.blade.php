                                ...
                                <div class="flex items-center">
                                    <div class="w-10 h-10 flex-shrink-0">
                                        <div class="w-full h-full bg-gray-700 rounded-full overflow-hidden shadow-inner text-center bg-purple table">
                                            <span class="table-cell text-sm text-white font-bold align-middle">{{ (\App\Models\User::find($record->user_id))->initials }}</span>
                                        </div>
                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">
                                        {{ (\App\Models\User::find($record->user_id))->name }}
                                        </div>
                                    </div>
                                </div>
                            </td>
