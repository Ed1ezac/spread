...
@section('features')
<!--
    from, recipients, text-snapshot, rollout-time
-->
    ...
    <div class="shadow-sm overflow-hidden rounded max-w-lg border-t-4 border-gray-500">
        ...
        <div class="flex justify-between px-4 py-3 bg-gray-50 sm:px-6">
            ...
            <div class="flex">
                ...
                <span class="sm:block">
                    <button class="inline-flex justify-center py-2 px-4 my-btn shadow-md bg-primary-500 hover:bg-primary-700 focus:ring-primary-800">
                        <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<!--div class="">
    <div class="ml-12 flex">
        <div class="mt-32 mb-12">
            ...
            <p class="text-gray-500 mt-1">Scheduled message rollouts are created when you choose "send later" on the sms creation wizard.</p>
            
            <span class="sm:block mt-3">
                <button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-sm shadow-md text-sm font-medium text-white bg-gray-700 hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
