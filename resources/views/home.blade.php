        ...
        <div class="flex flex-col h-full justify-center items-center">
          <div class="text-center">
            ...
            <div class="px-4 py-3 mt-4 text-center sm:px-6">
              @if(!Auth::check())
              <a href="/register" class="inline-flex justify-center py-2 px-4 mr-4 shadow-md my-btn border-primary-500 bg-primary-500 hover:bg-primary-700 focus:ring-primary-800">
              ...
              @endif
              <a href="" class="inline-flex justify-center py-2 px-4 my-btn border-white text-gray-700 bg-white hover:border-primary-500 hover:bg-primary-500 focus:ring-primary-800">
